...
void SDLTest_TrackAllocations(void)
{
    ...
    do {
        ...
        *(SDL_FunctionPointer*)&dyn_dbghelp.pSymInitialize = SDL_LoadFunction(dyn_dbghelp.module, "SymInitialize");
        *(SDL_FunctionPointer*)&dyn_dbghelp.pSymFromAddr = SDL_LoadFunction(dyn_dbghelp.module, "SymFromAddr");
        *(SDL_FunctionPointer*)&dyn_dbghelp.pSymGetLineFromAddr64 = SDL_LoadFunction(dyn_dbghelp.module, "SymGetLineFromAddr64");
