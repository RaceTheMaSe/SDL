...
int main(int argc, char **argv)
{
    ...
    typedef bool (*tray_click_fn)(void *, SDL_Tray *);
    SDL_FunctionPointer fp_left;
    SDL_FunctionPointer fp_right;
    SDL_FunctionPointer fp_middle;
    *(tray_click_fn*)&fp_left = tray2_leftclick;
    *(tray_click_fn*)&fp_right = tray2_rightclick;
    *(tray_click_fn*)&fp_middle = tray2_middleclick;
